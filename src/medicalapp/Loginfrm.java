...
public class Loginfrm extends javax.swing.JFrame {
   ...
   public static boolean loginAcc(String user, String pass){
    ...
    try{
        String query = "SELECT * FROM tbl_med WHERE u_username = '" + user + "' AND u_pass = '" + pass + "' AND u_status = '" +"Active" + "' ";
    ...
    private void initComponents() {
        ...
        accty = new javax.swing.JComboBox<>();
        ...
        jPanel1.add(jLabel9);
        jLabel9.setBounds(460, 160, 80, 17);

        jLabel14.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabel14.setText("Password:");
        jPanel1.add(jLabel14);
        jLabel14.setBounds(460, 210, 100, 17);
        jPanel1.add(us);
        us.setBounds(550, 140, 270, 40);
        ...
        jPanel1.add(ps);
        ps.setBounds(550, 190, 270, 40);

        accty.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        accty.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Doctor", "Pharmacist" }));
        jPanel1.add(accty);
        accty.setBounds(550, 250, 130, 30);

        typelbl.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        typelbl.setText("Account Type");
        jPanel1.add(typelbl);
        typelbl.setBounds(550, 290, 120, 15);
    ...
    private void loginbuttonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_loginbuttonMouseClicked
        String type = accty.getSelectedItem().toString();
        String stat = "SELECT Status from tbl_med";
        ...
        if(loginAcc(us.getText(), ps.getText())){
            ...
            JOptionPane.showMessageDialog(null, "Account Not Found or Still Pending!");
            us.setText("");
            ps.setText("");
        }
    ...
    private javax.swing.JComboBox<String> accty;
